...
public class Interpreter {
     ...
     * 
     * @param memory the memory instance this interpreter is associated with
     */
    ...
    /**
     * interprets the start of the passed instruction and passes it to the
     * responsible handler
     * 
     * @param ins           String representation of the instruction to be executed
    ...
    /**
     * Handles the assign x y instructions by setting the variable x to the value y
     * in memory
     * 
     * @throws IOException
     */
    ...
    private int addHandler() throws IOException {
        ...
        // 5. if first operand was a variable in memory then store the result as its
        // value
    ...
    private String readFileHandler() throws IOException {
        ...
        // 2. check if the read token is another system call and if so then handle first
        ...
        // memory if so use the value of the variable as the fileName
        // 4. if not a variable name then use the token as a fileName directly
        // 5. use the Scanner class with the Scanner(String fileName) constructor and
        // the readFile() method (that you should write, I didn't) to read the contents
    ...
    private void writeFileHandler() throws IOException {
        ...
        // 2. check if the read token is another system call and if so then handle first
        // the system call and then use the result as the fileName
        // 3. if not sys call then should check if it is a variable in memory and if so
        // use the value of the variable as a fileName and if not then use the token as
        // a fileName directly
        ...
        // 7. use the PrintWriter class (should be imported) to write the data to the
        // file
